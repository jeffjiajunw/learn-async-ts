...
function animateAliceSequentially() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    // Animate alice1 and wait until its animation is finished.
                    return [4 /*yield*/, alice10.animate(aliceTumbling1, aliceTiming1).finished];
                case 2:
                    // Animate alice1 and wait until its animation is finished.
                    _a.sent();
                    // Animate alice2 and wait until its animation is finished.
                    return [4 /*yield*/, alice20.animate(aliceTumbling1, aliceTiming1).finished];
                case 3:
                    // Animate alice2 and wait until its animation is finished.
                    _a.sent();
                    // Animate alice3 and wait until its animation is finished.
